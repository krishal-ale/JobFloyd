      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mb-6">
          <div className="flex items-center gap-2 border border-gray-200 rounded-xl px-3 py-2 bg-white w-full sm:w-72">
            ...
            <Input className="border-none shadow-none focus-visible:ring-0 text-sm p-0 h-auto" placeholder="Filter by company name" onChange={(e) => setInput(e.target.value)} value={input}/>
          </div>
          <Button className="bg-[#0066FF] hover:bg-blue-700 text-white rounded-xl px-5 flex items-center gap-2 shrink-0 w-full sm:w-auto" onClick={() => navigate("/admin/company/register")}>
