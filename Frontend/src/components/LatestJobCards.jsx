...
const LatestJobCards = ({job}) => {
  return (
    <div className='p-5 rounded-2xl bg-white border border-gray-400 shadow-md cursor-pointer hover:shadow-blue-100 hover:border-[#0066FF] transition-all duration-200'>
